  ...
  const modalConfig = useMemo(() => {
    if (twoFactorEnabled) {
      return {
        ...
        description: "El doble factor est\xE1 activo. Escanea el QR o introduce la clave en tu app de autenticaci\xF3n.",
        buttonText: "Cerrar"
      };
    }
    if (showVerificationStep) {
      return {
        title: "Verificar c\xF3digo",
        description: "Introduce el c\xF3digo de 6 d\xEDgitos de tu app",
        buttonText: "Continuar"
      };
    }
    return {
      title: "Activar doble factor",
      description: "Para terminar, escanea el QR o introduce la clave en tu app de autenticaci\xF3n",
      buttonText: "Continuar"
    };
