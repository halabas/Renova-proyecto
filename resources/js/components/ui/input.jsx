  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        data-slot="input"
        className={cn(
          "flex w-full min-w-0 rounded-[20px] border-2 border-[#d9d9d9] bg-white px-5 py-4 text-[18px] shadow-xs placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground transition-[color,box-shadow] outline-none",
